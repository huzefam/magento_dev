...
class Magestore_Giftwrap_Helper_Data extends Mage_Core_Helper_Abstract
{
	...
	*/
    public function enableGiftwrap ()
    {
        ...
        if (Mage::getStoreConfig('giftwrap/general/active')) {
            if (count(
            Mage::getModel('giftwrap/giftwrap')->getCollection()
	...
	*/
    ...
    {
        return Mage::getStoreConfig('giftwrap/general/icon_image');
    }
    /*
	...
	*/
    ...
    {
        return Mage::getStoreConfig('giftwrap/general/amount_on_number_items');
    }
    /*
	...
	*/
	...
	{
		return Mage::getStoreConfig('giftwrap/general/use_card', $this->getStoreId());
	}
