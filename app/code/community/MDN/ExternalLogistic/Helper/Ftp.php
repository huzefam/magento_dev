 ...
 */
class MDN_ExternalLogistic_Helper_Ftp extends Mage_Core_Helper_Abstract
{
        private $_host = null;
        private $_port = null;
        private $_login = null;
	 ...
	 *
	 */
	public function downloadFilesMatchingPattern($remoteDirectory, $patterns, $runDirectory)
	{
		...
		foreach ($remoteFiles as $remoteFile)
		{
			...
			{
				if (preg_match($pattern, $remoteFile))
				{
	...
	protected function getConnection()
	{
		...
		if (!$connId)
			throw new Exception('Unable to connect to ftp server, please check ftp logins in system > configuration > External logistic');
